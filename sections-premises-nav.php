<section id="premises-nav" class = "nav-section-content">
	<article class="section-content">
		...
		<main>
			...
			<p>
				The Office imagines alternative and better futures through applied design research.
			</p> 
			<p>
				It aspires to reduce the distance between design innovation and societal impact.
			</p>			
		</main>
	</article>
</section>
